...
<div id="testheader">
      <div class="container">
        ...
        <div class="col-md-6">
           <p>User: USR${sessionScope.user.id} ${sessionScope.user.name}</p>
            <p>Current Date : <%
...
%>	<div class="main_contents">
    		<div id="sub_content">
         <form action="UserStudentRegistrationServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
           ...
           <%--  <div class="row mb-4">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input  type="date" class="form-control" id="date" name="date" value="${ sr.date}">
                </div>
            ...
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="form-check-inline">
                        <input <c:if test="${sr.gender=='male' }">checked</c:if> class="form-check-input" type="radio" name="gender" id="gridRadios1" value="male"
                            >
                    ...
                    <div class="form-check-inline">
                        <input <c:if test="${sr.gender=='female' }">checked</c:if> class="form-check-input" type="radio" name="gender" id="gridRadios2" value="female">
            ...
            <div class="row mb-4" >
                ...
                <div class="col-md-4">
                    <input type="tel" class="form-control" id="phone" name="phone" value="${sr.phone }">
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" aria-label="Education" id="education" name="education">
                        <option <c:if test="${sr.education=='Bachelor of Information Technology' }">selected</c:if> value="Bachelor of Information Technology">Bachelor of Information Technology</option>
                        <option <c:if test="${sr.education=='Diploma in IT' }">selected</c:if> value="Diploma in IT">Diploma in IT</option>
                        <option <c:if test="${sr.education=='Bachelor of Computer Science' }">selected</c:if> value="Bachelor of Computer Science">Bachelor of Computer Science</option>
                ...
                <div class="col-md-4">
				  ...
				  <c:forEach items="${list }" var="list">
				   	 <div class="form-check-inline col-md-3">
				                        <input  class="form-check-input" <c:forEach var="substring" items="${sr.attend.split(',')}">  <c:if test="${substring==list.course_name  }">checked</c:if> </c:forEach> type="checkbox" name="attend" id="attend" value="${list.course_name }"  multiple="multiple">
				                        <label class="form-check-label" for="gridRadios2">
				                           ${list.course_name }
				                        </label>
				                    </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="file" class="form-control" id="part" name="part">
                </div>
