    ...
    <div id="sub_content">
        ...
        <table class="table table-striped" id="stduentTable">
            ...
            <c:forEach items="${list }" var="u">
                ...
                <td>
                    <button type="button" class="btn btn-success  " onclick="location.href = 'CourseUpdateServlet?id=${u.id}&name=${u.course_name }';">
                        Update
                    </button>
                </td>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success col-md-2" data-bs-dismiss="modal" onclick="location.href = 'CourseDeleteServlet?id=${u.id}';">Ok</button>
